...
def get_extension_icon(ext):
    category = categorize(ext)
    if category == 'textFiles':
        return 'fas fa-file'
    elif category == 'imageFiles':
        return 'fas fa-image'
    elif category == 'devFiles':
        return 'fas fa-code'
    elif category == 'spreadsheetFiles':
        return 'fas fa-file-excel'
    elif category == 'systemFiles':
        return 'fas fa-file'
    elif category == 'executableFiles':
        return 'fab fa-windows'
    elif category == 'archiveFiles':
        return 'fas fa-file-archive'
    elif category == 'backupFiles':
        return 'fas fa-file'
    elif category == 'audioFiles':
        return 'fas fa-music'
    elif category == 'databaseFiles':
        return 'fas fa-database'
    elif category == 'presentationFiles':
        return 'fas fa-file-powerpoint'
    elif category == 'videoFiles':
        return 'fas fa-video'
    elif category == 'bookmarkFiles':
        return 'fas fa-file'
    elif category == 'PIMFiles':
        return 'fas fa-file'
    elif category == 'shortcutFiles':
        return 'fas fa-file'
    else:
        return 'fas fa-file'
